...
class OnnxModel
{
 ...
 public:
  ...
  // Inferencing
  void initModel(std::string, bool = false, int64_t = -1, int64_t = -1);
  ...
  int64_t getValidityFrom() const { return validFrom; }
  int64_t getValidityUntil() const { return validUntil; }
